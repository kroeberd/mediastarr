...
- [x] Config export/import, update notifications, CodeQL hardening, tooltips *(v7.1.2–v7.1.12)*
...
- [x] Config-Export/Import, Update-Benachrichtigungen, CodeQL-Härtung, Tooltips *(v7.1.2–v7.1.12)*
